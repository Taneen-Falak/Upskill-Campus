    ...
    def __init__(self,root):
        ...
        def generateFunction(entry1: Entry,entry2: Entry):
            ...
            for i in range(10):
                ...
                if a==1:
                    password_list.append(smallLetters[random.randint(0,len(smallLetters)-1)])
                elif a==2:
                    password_list.append(capitalLetters[random.randint(0,len(capitalLetters)-1)])
                elif a==3:
                    password_list.append(numbers[random.randint(0,len(numbers)-1)])
                else:
                    password_list.append(specialCharacters[random.randint(0,len(specialCharacters)-1)])
        ...
        Button(self.root,text="Generate Password",command=lambda: generateFunction(self.txt_password,self.txt_cpassword ),font=("Times new roman",8), bd=0,cursor="hand2",background="Pink").place(x=1150,y=440, width=90)
        ...
        btn_login=Button(self.root,text="Sign In",command=self.login_window,font=("Times new roman",20), bd=0,cursor="hand2",background="Pink").place(x=200,y=540, width=180)
          ...
          messagebox.showerror("Error","Password and confirm password should be same",parent=self.root)
            ...
            try:
                ...
                if row!=None:
                    ...
                    con.commit()
                    con.close()
                    messagebox.showerror("Error","Register Successfull",parent=self.root)
                    self.clear()
